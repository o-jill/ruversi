...
const use_i16 : bool = false;  // i32  // 575
...
if use_i16 {
            ...
            let ml1 = x86_64::_mm_sign_epi16(x41, c16l);
            let ml3 = x86_64::_mm_sign_epi16(x43, c16h);
            ...
            let ml1 = x86_64::_mm_sign_epi32(x41, c1);  // -x , 0, +x
            let ml2 = x86_64::_mm_sign_epi32(x42, c2);
            let ml3 = x86_64::_mm_sign_epi32(x43, c3);
            let ml4 = x86_64::_mm_sign_epi32(x44, c4);
            ...
            for n in 0..N {
                ...
                for j in 0..board::CELL_2D / M {
                    ...
                    unsafe {
                        ...
                        let mul1 = x86_64::_mm256_sign_epi32(x81, c81);
                        let mul2 = x86_64::_mm256_sign_epi32(x82, c82);
                        let mul3 = x86_64::_mm256_sign_epi32(x83, c83);
                        let mul4 = x86_64::_mm256_sign_epi32(x84, c84);
...
if BRD_INT {
        unsafe {
            let x11 = x86_64::_mm256_load_si256(isum48.as_ptr() as *const x86_64::__m256i);
            let x21 = x86_64::_mm256_load_si256(isum48.as_ptr().add(8) as *const x86_64::__m256i);
            let x31 = x86_64::_mm256_load_si256(isum48.as_ptr().add(16) as *const x86_64::__m256i);
            let x41 = x86_64::_mm256_load_si256(isum48.as_ptr().add(24) as *const x86_64::__m256i);
            // ABCDEFGH + IJKLMNOP -> AB CD IJ KL EF GH MN OP
            let x12 = x86_64::_mm256_hadd_epi32(x11, x21);
            let x34 = x86_64::_mm256_hadd_epi32(x31, x41);
            // ABCD IJKL ABCD2 IJKL2 EFGH MNOP EFGH2 MNOP2
            let x1234 = x86_64::_mm256_hadd_epi32(x12, x34);
            let x1 = x86_64::_mm256_extracti128_si256(x1234, 0);
            let x2 = x86_64::_mm256_extracti128_si256(x1234, 1);
            let h1234 = x86_64::_mm_add_epi32(x1, x2);
        ...
        unsafe {
            let x11 = x86_64::_mm256_load_ps(sum48.as_ptr());
            let x12 = x86_64::_mm256_load_ps(sum48.as_ptr().add(8));
            let x13 = x86_64::_mm256_load_ps(sum48.as_ptr().add(16));
            let x14 = x86_64::_mm256_load_ps(sum48.as_ptr().add(24));

            // ABCDEFGH + IJKLMNOP -> AB CD IJ KL EF GH MN OP
            let x21 = x86_64::_mm256_hadd_ps(x11, x12);
            let x43 = x86_64::_mm256_hadd_ps(x13, x14);
            // ABCD IJKL ABCD2 IJKL2 EFGH MNOP EFGH2 MNOP2
            let x1234 = x86_64::_mm256_hadd_ps(x21, x43);
            let x1 = x86_64::_mm256_extractf128_ps(x1234, 0);
            let x2 = x86_64::_mm256_extractf128_ps(x1234, 1);
            let h1234 = x86_64::_mm_add_ps(x1, x2);
